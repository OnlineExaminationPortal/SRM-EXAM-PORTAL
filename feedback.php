...
<div class="col-md-10">
<a href="sm6839@gmail.com" style="color:#000000">sd123@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
    <img src="image/img1.jpeg" width=100 height=100  class="img-rounded"><br><br><br><br>
     <img src="image/img 2.jpeg" width=100 height=100  class="img-rounded"><br><br><br><br>
     <img src="image/img 3.jpeg" width=100 height=100  class="img-rounded"><br><br><br><br>
     <img src="image/img4.jpeg" width=100 height=100  class="img-rounded"><br><br><br><br><br>
		 </div>
		 <div class="col-md-5">
     <a href= # style="color:#202020; font-family:'typo' ; font-size:18px" ">Soumya Mohanty</a>
		...
		<h4 style=div"font-family:'typo' "> <b>SRM Insitute of Science & Technology,Kattankulatur, Chennai</b></h4><br>
